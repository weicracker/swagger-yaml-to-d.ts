    ...
    _.forEach(swagger.paths, function(api, path){
        ...
        _.forEach(api, function(op, m){
            ...
            var method = {
                ...
                returnType:op.responses['200'].schema.$ref.replace("#/definitions/",""),
            ...
            if((method.parameters).length>1&&method.parameters[0].name==="XASPSESSION"){
                let first = method.parameters.shift();
                method.parameters.push(first);
            }
...
var getCode = function(opts, type) {
    ...
    fs.writeFileSync("e:aaaa.json",JSON.stringify(data),"UTF-8")
