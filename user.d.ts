...
declare namespace USERAPI {
    ...
    class USERAPIController {
        ...
        public queryUsers(XASPSESSION ? : string, name ? : string, ): Promise < {
        ...
        public queryFriends(XASPSESSION ? : string, name ? : string, ): Promise < {
        ...
        public concernUsers(XASPSESSION ? : string, userIds ? : string, ): Promise < {
            response: http.ClientResponse;body: JsonResultSXLOfstring;
        } > ;
        public deleteConcernUsers(XASPSESSION ? : string, userIds ? : string, ): Promise < {
            response: http.ClientResponse;body: JsonResultSXLOfstring;
        } > ;
        public queryConcernUsers(XASPSESSION ? : string, concernid ? : string, ): Promise < {
        ...
        public updateCurrent(XASPSESSION ? : string, userOrgVO ? : UserOrgVO, ): Promise < {
            response: http.ClientResponse;body: JsonResultSXLOfUserIdVO;
        } > ;
        ...
        public changePwd(XASPSESSION ? : string, userPassword ? : UserPassword, ): Promise < {
            response: http.ClientResponse;body: JsonResultSXLOfstring;
        } > ;
        ...
        public addFriends(XASPSESSION ? : string, userIds ? : string, ): Promise < {
            response: http.ClientResponse;body: JsonResultSXLOfstring;
        } > ;
        public deleteFriends(XASPSESSION ? : string, userIds ? : string, ): Promise < {
            response: http.ClientResponse;body: JsonResultSXLOfstring;
        } > ;
        public getFriGroup(XASPSESSION ? : string, ): Promise < {
            response: http.ClientResponse;body: JsonResultSXLOfArrayListOfGroupVO;
        } > ;
        public createFrgroup_1(XASPSESSION ? : string, frgroupvo ? : FrgroupVO, ): Promise < {
        ...
        public createFrgroup(XASPSESSION ? : string, id ? : string, name ? : string, ): Promise < {
            response: http.ClientResponse;body: JsonResultSXLOfGroupIdVO;
        } > ;
        public delgroup(XASPSESSION ? : string, id: string, ): Promise < {
            response: http.ClientResponse;body: JsonResultSXLOfstring;
        } > ;
        ...
        public delMember(XASPSESSION ? : string, ids: string, ): Promise < {
            response: http.ClientResponse;body: JsonResultSXLOfstring;
        } > ;
        ...
        public queryUsercode(XASPSESSION ? : string, userCode ? : string, ): Promise < {
            response: http.ClientResponse;body: JsonResultSXLOfstring;
        } > ;
        public queryUseremail(XASPSESSION ? : string, userEmail ? : string, ): Promise < {
            response: http.ClientResponse;body: JsonResultSXLOfstring;
        } > ;
        public queryUsertel(XASPSESSION ? : string, userTel ? : string, ): Promise < {
            response: http.ClientResponse;body: JsonResultSXLOfstring;
        } > ;
